...
public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        //  checkingHero();
        System.out.println(Calculator.calculatingDiscount(90, 10));
        //assertThatThrownBy(()->Calculator.calculatingDiscount(90, 10)).isInstanceOf(IllegalStateException.class);
