...
//        ).isInstanceOf(IllegalStateException.class);
        ...
        //assertThat(Calculator.calculatingDiscount(90, 10)).isEqualTo(81);
        assertThat(Calculator.calculatingDiscount(90, 10)).isEqualTo(81);
        assertThatThrownBy(() -> Calculator.calculatingDiscount(90, 0)).isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> Calculator.calculatingDiscount(0, 10)).isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> Calculator.calculatingDiscount(-90, 10)).isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> Calculator.calculatingDiscount(90, -10)).isInstanceOf(IllegalArgumentException.class);
    }
}